...
## Orion Prosper Lakes - Excellent Performance with Data Enhancement Needed
...
This analysis evaluates Orion Prosper Lakes waste management operations (308 units). The property demonstrates **excellent cost performance** with a CPD of $13.09—well below the portfolio average. However, analysis is based on 3 sample invoices out of 10 available, requiring additional extraction for comprehensive insights.
...
|--------|-------|--------|
| **Property Units** | 308 | |
| **Monthly Cost** | $4,031.72 | Based on 3 sample invoices |
| **Annual Cost** | $48,380.64 | |
| **Cost Per Door** | $13.09 | ✓ **Excellent - Below portfolio avg** |
| **Portfolio CPD Average** | $16.31 | |
| **Savings vs Portfolio** | $3.22/door | ✓ **$11,901.12/year advantage** |
| **Yards Per Door** | 0.29 | ⚠️ Low - potential capacity concern |
| **Vendor** | Republic Services | |
| **Container Size** | 30 YD | Assumed |
| **Pickup Frequency** | 2x/week | Assumed |
| **Data Quality** | Medium | 🟡 **7 invoices need extraction** |
...
Orion Prosper Lakes is a **top performer** in the Orion portfolio:

**Cost Comparison:**
```
Orion Prosper Lakes CPD:        $13.09
Portfolio Average CPD:      $16.31
Advantage:                  $3.22 per door
```

**Annual Savings vs Portfolio Average:**
```
Monthly savings:            $991.76
Annual savings:             $11,901.12
3-year cumulative:          $35,703.36
```
...
**Invoice Coverage:**
- Invoices found: 10 PDFs
- Invoices extracted: 3 (sample)
- Remaining: 7 invoices need extraction
- Coverage: 30% complete

**Impact of Limited Data:**
1. Monthly cost is estimated from 3-month sample
...
2. ✅ **Locate Service Contract**
   - Search property files for Republic Services agreement
...
4. ✅ **Complete Data Validation**
   - Verify $4,031.72 monthly cost with full dataset
...
6. ✅ **Service Audit**
   ...
   - Assess if YPD of 0.29 indicates capacity issues
...
1. **Insufficient Container Capacity** (Most Likely)
   - Too few containers for 308 units
...
**Recommendation:**
- Extract all 10 invoices to verify actual container configuration
...
**Current advantage:**
- Saving $11,901.12/year vs portfolio average
...
**Value Protection:**
```
Current annual cost:        $48,380.64
If rates increase 10%:      $53,218.70 (+$4,838.06)
If rates increase 20%:      $58,056.77 (+$9,676.13)
...
- Add 1-2 containers: +$604.76-$1,007.93/month estimated
...
- Range: $403.17-$604.76/month
- Annual: $4,838.06-$7,257.10
...
**Property Profile:**
- Location: Prosper Lakes
- Units: 308
- Vendor: Republic Services
- Current CPD: $13.09

**Market Rate Assessment:**
- Typical CPD for 308-unit property: $13.00-$18.00
- Current CPD: $13.09
...
Annual Cost:                $48,380.64
Cost Per Door:              $13.09
Annual Advantage vs Avg:    $11,901.12
```
...
Year 3: $58,540.57
Total:  $160,139.92
Delta vs Scenario 2: $7,619.95
```

**Interpretation:** Securing rate protection is worth $7,619.95 over 3 years compared to uncontrolled increases.
...
1. ✅ **Complete Invoice Extraction**
   ```
   Extract all 10 invoices using Claude Vision OCR
   Priority data points:
   - Monthly costs (verify $4,031.72 estimate)
...
2. ✅ **Contract Retrieval**
   - Locate Republic Services service agreement
...
**Orion Prosper Lakes is a strong performer** with a Cost Per Door of $13.09—well below the portfolio average of $16.31. This translates to **$11,901.12 in annual savings** compared to average portfolio performance.
...
2. **Complete Data Collection** - Extract remaining 7 invoices to enable comprehensive analysis and trend identification

3. **Address Low YPD** - Investigate 0.29 YPD to determine if capacity expansion is needed or if data needs correction
