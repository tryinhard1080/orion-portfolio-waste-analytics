...
## Orion Prosper - Excellent Performance with Data Enhancement Needed
...
This analysis evaluates Orion Prosper waste management operations (312 units). The property demonstrates **excellent cost performance** with a CPD of $13.81—well below the portfolio average. However, analysis is based on 3 sample invoices out of 16 available, requiring additional extraction for comprehensive insights.
...
|--------|-------|--------|
| **Property Units** | 312 | |
| **Monthly Cost** | $4,308.72 | Based on 3 sample invoices |
| **Annual Cost** | $51,704.64 | |
| **Cost Per Door** | $13.81 | ✓ **Excellent - Below portfolio avg** |
| **Portfolio CPD Average** | $16.31 | |
| **Savings vs Portfolio** | $2.50/door | ✓ **$9,360.00/year advantage** |
...
| **Data Quality** | Medium | 🟡 **13 invoices need extraction** |
...
Orion Prosper is a **top performer** in the Orion portfolio:

**Cost Comparison:**
```
Orion Prosper CPD:        $13.81
Portfolio Average CPD:      $16.31
Advantage:                  $2.50 per door
```

**Annual Savings vs Portfolio Average:**
```
Monthly savings:            $780.00
Annual savings:             $9,360.00
3-year cumulative:          $28,080.00
```
...
**Invoice Coverage:**
- Invoices found: 16 PDFs
- Invoices extracted: 3 (sample)
- Remaining: 13 invoices need extraction
- Coverage: 19% complete
...
4. ✅ **Complete Data Validation**
   - Verify $4,308.72 monthly cost with full dataset
...
1. **Insufficient Container Capacity** (Most Likely)
   - Too few containers for 312 units
...
**Recommendation:**
- Extract all 16 invoices to verify actual container configuration
...
1. **Excellent Cost Performance**
   - CPD of $13.81 is well below portfolio average
...
**Current advantage:**
- Saving $9,360.00/year vs portfolio average
...
**Value Protection:**
```
Current annual cost:        $51,704.64
If rates increase 10%:      $56,875.10 (+$5,170.46)
If rates increase 20%:      $62,045.57 (+$10,340.93)
...
- Add 1-2 containers: +$646.31-$1,077.18/month estimated
...
- Range: $430.87-$646.31/month
- Annual: $5,170.46-$7,755.70
...
- Typical CPD for 312-unit property: $13.00-$18.00
- Current CPD: $13.81
...
Annual Cost:                $51,704.64
Cost Per Door:              $13.81
Annual Advantage vs Avg:    $9,360.00
```
...
Year 3: $62,562.61
Total:  $171,142.36
Delta vs Scenario 2: $8,143.48
```

**Interpretation:** Securing rate protection is worth $8,143.48 over 3 years compared to uncontrolled increases.
...
1. ✅ **Complete Invoice Extraction**
   ```
   Extract all 16 invoices using Claude Vision OCR
   Priority data points:
   - Monthly costs (verify $4,308.72 estimate)
...
**Orion Prosper is a strong performer** with a Cost Per Door of $13.81—well below the portfolio average of $16.31. This translates to **$9,360.00 in annual savings** compared to average portfolio performance.
...
2. **Complete Data Collection** - Extract remaining 13 invoices to enable comprehensive analysis and trend identification
