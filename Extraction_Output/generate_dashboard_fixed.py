...
# Pre-built invoice rows
invoice_rows = """
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">0615-002267720</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2025-01-31</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">$774.50</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">$2.51</td>
                            </tr>

                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">0615-002353052</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2025-04-30</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">$2,950.50</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">$9.58</td>
                            </tr>
"""
html_content += invoice_rows
