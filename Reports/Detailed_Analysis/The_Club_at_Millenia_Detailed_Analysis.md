...
This analysis evaluates The Club at Millenia waste management operations (560 units). **Critical finding:** 6 PDF invoices have been identified but detailed extraction has not been completed, limiting the depth of this analysis.
...
|--------|-------|--------|
| **Property Units** | 560 | |
| **Monthly Cost (Estimated)** | $11,760.00 | ⚠️ Needs verification |
| **Annual Cost** | $141,120.00 | |
| **Cost Per Door** | $21.00 | Above portfolio average |
| **Portfolio CPD Average** | $16.31 | |
| **Variance from Portfolio** | $4.69 (+28.8%) | ⚠️ |
| **Yards Per Door** | 0.43 | ⚠️ Low - capacity concern |
...
4. ✅ **Complete Data Validation**
   - Verify $11,760.00 monthly cost estimate
...
6. ✅ **Service Audit**
   ...
   - Evaluate YPD of 0.43 (appears low)
...
|--------|-------|------------|
| **Monthly Cost** | $11,760.00 | ⚠️ Needs verification |
| **Cost Per Door** | $21.00 | Above portfolio average by $4.69 |
| **Annual Premium vs Portfolio Avg** | $31,516.80 | Paying extra vs average |
| **Yards Per Door** | 0.43 | ⚠️ Below typical range (2.5-4.0) |

### Cost Comparison

**vs Portfolio Average:**
- Club at Millenia CPD: $21.00
- Portfolio Average CPD: $16.31
- Variance: $4.69 higher per door
- Monthly impact: $2,626.40
- Annual impact: $31,516.80

**vs Best Performer (Bella Mirage):**
- Bella Mirage CPD: $10.87
- Club at Millenia CPD: $21.00
- Variance: $10.13 higher per door
- Monthly impact: $5,672.80
- Annual impact: $68,073.60
...
- Conservative (10%): $1,176.00/month ($14,112.00/year)
- Moderate (15%): $1,764.00/month ($21,168.00/year)
- Aggressive (20%): $2,352.00/month ($28,224.00/year)

**Basis:**
- CPD of $21.00 is 28.8% above portfolio average
...
2. **Above-Average Costs** - $21.00 CPD vs $16.31 average
...
```
Year 1:  $141,120.00
Year 2:  $148,176.00 (assuming 5% increase)
Year 3:  $155,584.80 (assuming 5% increase)
Total:   $444,880.80
```
...
```
Annual Savings:    $21,168.00
3-Year Savings:    $66,732.12
```

**Scenario 2: Service Optimization (10% savings)**
```
Annual Savings:    $14,112.00
3-Year Savings:    $44,488.08
```

**Scenario 3: Combined Optimization (20% savings)**
```
Annual Savings:    $28,224.00
3-Year Savings:    $88,976.16
```
...
- CPD of $21.00 is 28.8% above portfolio average
- YPD of 0.43 is concerning (potentially insufficient capacity)
- Estimated optimization potential: 10-20% ($14,112.00-$28,224.00/year)
