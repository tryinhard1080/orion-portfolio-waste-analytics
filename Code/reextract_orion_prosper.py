#!/usr/bin/env python3
"""
Re-extract ALL Orion Prosper invoices (16 PDFs)
...
# Configuration
ORION_PROSPER_FOLDER = Path("C:/Users/Richard/Downloads/Orion Data Part 2/Invoices/Orion Prosper Trash Bills")
...
# Find all PDFs
pdf_files = sorted(ORION_PROSPER_FOLDER.glob("**/*.pdf"))
print(f"Found {len(pdf_files)} PDFs for Orion Prosper")
print(f"Source folder: {ORION_PROSPER_FOLDER}")
...
- unit_rate: Unit rate as string without $ symbol (e.g., "2154.36") or null
- extended_amount: Line item total as string without $ symbol (e.g., "2154.36") or null

CRITICAL EXTRACTION RULES:
1. Property name is "Orion Prosper" (hardcoded)
...
output_file = OUTPUT_FOLDER / f"OrionProsper_ReExtraction_{timestamp}.json"

output_data = {
    "extraction_metadata": {
        "extraction_date": datetime.now().isoformat(),
        "property": "Orion Prosper",
        "source_folder": str(ORION_PROSPER_FOLDER),
...
# Print summary
print("\n" + "="*80)
print(" EXTRACTION SUMMARY - Orion Prosper")
print("="*80)
